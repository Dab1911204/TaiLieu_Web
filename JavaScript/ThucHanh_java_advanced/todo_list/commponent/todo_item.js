...
function Todo_item({todo,index,editIndex}){
    return html`
            		<li class="${todo.commpleted && 'completed'} ${editIndex === index && 'editing'}">
						<div class="view">
							<input class="toggle" type="checkbox" ${todo.commpleted && 'checked'} onchange="dispatch('toggle', ${index})">
...
export default connect()(Todo_item)
